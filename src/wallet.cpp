...
// bitlux: total coins staked (non-spendable until maturity)
...
// bitlux: check 'spent' consistency between wallet and txindex
// bitlux: fix wallet spent state according to txindex
...
// bitlux: disable transaction (only for coinstake)
